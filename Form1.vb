        ...
        If Not String.IsNullOrEmpty(videoUrl) Then
            Try
                ...
                If audioStreamInfo IsNot Nothing Then
                    ...
                    'Get file bitrate
                    Dim file As TagLib.File = TagLib.File.Create(audioFilePath)
                        Dim audioProperties As TagLib.Properties = file.Properties

                        Dim audiobitrate As Integer = audioProperties.AudioBitrate
                    ' Update the UI after extraction
                    extractionStatusLabel.Text = "Status: Audio extracted successfully! (Bitrate: " & audiobitrate & ")"
                Else
